...
const getUserCart = async () => {
  ...
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/api/cart/users/${userId}/cart`);
...
const updateCartProduct = async (cartId, productId, quantity) => {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/cart/carts/${cartId}/products/${productId}/quantity/${quantity}`,
      {
        method: "PUT",
        headers: {
...
const deleteProductFromCart = async (cartId, productId) => {
  try {
    const response = await fetch(
      `${process.env.REACT_APP_API_URL}/api/cart/carts/${cartId}/product/${productId}`,
      {
        method: "DELETE",
      }
    );    
