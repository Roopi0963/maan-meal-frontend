...
const AddressPage = () => {
    ...
    const addAddress = async () => {
        try {
            await axios.post(`${process.env.REACT_APP_API_URL}/api/addresses/${userId}`, newAddress);
            fetchAddresses();
            resetForm();
        } catch (error) {
    ...
    const updateAddress = async () => {
        ...
        try {
            await axios.put(`${process.env.REACT_APP_API_URL}/api/addresses/${editingAddressId}`, newAddress);
            fetchAddresses();
            resetForm();
        } catch (error) {
    ...
    const deleteAddress = async (id) => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/api/addresses/${id}`);
    ...
    const placeOrder = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/api/orders/place/${userId}/${addressId}`, {
                method: "POST",
              });              
